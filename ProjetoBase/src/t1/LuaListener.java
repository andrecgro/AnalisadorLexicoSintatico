...
public interface LuaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LuaParser#var2}.
	 * @param ctx the parse tree
	 */
	void enterVar2(LuaParser.Var2Context ctx);
	/**
	 * Exit a parse tree produced by {@link LuaParser#var2}.
	 * @param ctx the parse tree
	 */
	void exitVar2(LuaParser.Var2Context ctx);
	/**
	 * Enter a parse tree produced by {@link LuaParser#cham2}.
	 * @param ctx the parse tree
	 */
	void enterCham2(LuaParser.Cham2Context ctx);
	/**
	 * Exit a parse tree produced by {@link LuaParser#cham2}.
	 * @param ctx the parse tree
	 */
	void exitCham2(LuaParser.Cham2Context ctx);
	/**
